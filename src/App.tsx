          ...
          <nav className="hidden md:flex items-center gap-10">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="font-sans text-[15px] font-medium tracking-[0.1em] uppercase text-charcoal/70 hover:text-accent transition-colors duration-300"
              >
                {item.name}
              </a>
            ))}
    ...
    <section id="главная" className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <div className="animate-fade-in-up">
          ...
          <p className="text-accent-light font-sans text-sm md:text-base tracking-[0.4em] uppercase mb-8">
            ...
            <a
              href="#услуги"
              className="inline-block px-12 py-4 bg-accent text-white hover:bg-accent-dark transition-all duration-500 text-xs tracking-[0.3em] uppercase font-sans font-medium shadow-lg hover:shadow-xl"
            >
              Наши услуги
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 min-h-[320px]">
          ...
          <div className="lg:col-span-3 flex flex-col justify-center p-8 md:p-12 lg:pl-16 relative">
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className={`px-3 py-1 text-[10px] tracking-[0.2em] uppercase font-sans font-medium ${
              ...
              <span className="text-white/40 text-xs font-sans tracking-wider">
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <span className="text-white/30 text-xs font-sans ml-2">
    ...
    <section id="услуги" className="py-24 md:py-32 bg-ivory">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <p className="text-accent text-xs tracking-[0.4em] uppercase mb-4 font-sans">Что мы предлагаем</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 md:-right-6 bg-charcoal text-white p-6 rounded-sm">
              ...
              <p className="text-xs tracking-[0.2em] uppercase text-white/60 mt-1 font-sans">лет опыта</p>
            </div>
          </div>

          {/* Text */}
          <div>
            <p className="text-accent text-xs tracking-[0.4em] uppercase mb-4 font-sans">О нашем ателье</p>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-5 bg-white/60 border border-sand rounded-sm">
                ...
                <p className="text-[10px] text-charcoal/50 mt-1 tracking-wider uppercase font-sans">Год основания</p>
              </div>
              <div className="text-center p-5 bg-white/60 border border-sand rounded-sm">
                <p className="font-serif text-3xl font-semibold text-accent-dark">10 000+</p>
                <p className="text-[10px] text-charcoal/50 mt-1 tracking-wider uppercase font-sans">Наименований</p>
              </div>
              <div className="text-center p-5 bg-white/60 border border-sand rounded-sm">
                <p className="font-serif text-3xl font-semibold text-accent-dark">4</p>
                <p className="text-[10px] text-charcoal/50 mt-1 tracking-wider uppercase font-sans">Страны</p>
              </div>
            </div>
          </div>
        </div>
...
function Fabrics() {
  return (
    <section id="ткани" className="py-24 md:py-32 bg-ivory">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <p className="text-accent text-xs tracking-[0.4em] uppercase mb-4 font-sans">Салон тканей</p>
...
function Gallery() {
  return (
    <section id="работы" className="py-24 md:py-32 bg-warm-gray">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <p className="text-accent text-xs tracking-[0.4em] uppercase mb-4 font-sans">Портфолио</p>
...
function Contacts() {
  return (
    <section id="контакты" className="py-24 md:py-32 bg-charcoal text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <p className="text-accent-light text-xs tracking-[0.4em] uppercase mb-4 font-sans">Свяжитесь с нами</p>
          ...
          <div>
            ...
            <div className="space-y-7">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-sans text-sm tracking-wider uppercase text-white/80 mb-1">Адрес</p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-sans text-sm tracking-wider uppercase text-white/80 mb-1">Телефон</p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-sans text-sm tracking-wider uppercase text-white/80 mb-1">Время работы</p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="font-sans text-sm tracking-wider uppercase text-white/80 mb-1">Сайт</p>
    ...
    <footer className="bg-anthracite py-10 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/30 text-center tracking-wider font-sans">
            © 1998–2026 Ателье Премиум класса · Алматы · Все права защищены
          </p>
          <div className="flex gap-6">
            <a href="https://premium-fabric.kz" target="_blank" rel="noopener noreferrer" className="text-xs text-white/30 hover:text-accent-light transition-colors tracking-wider font-sans">
              premium-fabric.kz
            </a>
          </div>
        </div>
